...
echo Installasjonskommandoen er kopiert, og Python FELLES er apnet.
...
:NOSCRIPT
echo Finner ikke install_python_felles.py i prosjektmappen.
pause
goto :EOF
